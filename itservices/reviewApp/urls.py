...
from . import views
from .views import ProductListView, ProductDetailView, ProductCreateView, ReviewCreateView, ReviewUpdateView, ReviewDetailView, ReviewListView, ReviewDeleteView
